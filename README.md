...
Everything on these webpages and in this repository ***except for the screenshots, .odt files, .docx files, [fonts](#fonts), Microsoft Word logo, LibreOffice Writer logo, and Winboat logo*** are created by me and under the Attribution-NonCommercial-ShareAlike 4.0 International license. (The screenshots were taken by me, but I did not create the programs they depict. I created the [.odt & .docx files](https://github.com/lunanerdderg/MLA-on-Linux.github.io/tree/main/templates), but they are under the [CC0 1.0 Universal license](https://github.com/lunanerdderg/MLA-on-Linux.github.io/blob/main/ODT-and-DOCX-file-LICENSE.txt). All html files, all CSS files, the home icon, and the A4 vs. US Letter comparison graphic were created by me, and are all under the CC BY-NC-SA 4.0 International license.)
...
* You credit me
* You link to the CC BY-NC-SA 4.0 International license
* You specify if you made any changes
* You make it clear that I do not endorse you or whatever you are using this for
* You do not use this for commercial purposes
